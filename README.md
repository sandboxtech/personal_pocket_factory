...
- 环里**没有任何矿产**，中间有一小片 4×4 浅水（走得过去；四面岸上都能架海洋泵）
- 12 个收货箱**横排**成上下两行，夹着中间的水池（和水池之间各留 2 格岸）；机械臂从箱阵外侧（上下两面）取货
- 高度固定 **64 格**：中间 32 格可建，上下各 16 格临空。宽度随经验增长
- **永昼**，太阳能板 24 小时满出力，不用蓄电池也不会半夜停摆
- 死亡后一律在自己环里复活，且**每 3 小时至多补发一套起始装备**（模块装甲 + 个人机器人指令模块 + 6 块太阳能板 + 10 个建造机器人，装备直接穿好插好，机器人在背包里）
...
- **全宇宙同时最多 12 个**。放第 13 个时，**最早放下的那个**自动退回你的背包
- 箱子**谁都打不开**，进出全靠机械臂

12 个名额是全宇宙合计，不按星球平摊——全铺开覆盖五颗星球，还是把好几个堆在刚重置完的那颗上抢一轮产出，你自己权衡。
