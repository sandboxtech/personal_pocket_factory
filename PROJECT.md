...
理由：玩家用关联箱一趟就能把公共世界里任何白给的物资运回戴森环，而戴森环不重置。放在
公共世界的任何物资，最终都会变成永久收益，这和「星球会重置、环才是长期平台」的核心节奏
直接冲突。（据点同理不放：公共世界的定位是有时限的资源场，不是战斗关卡。）
...
| `scripts/worlds.lua` | 公共世界（五星球）：确保 surface 存在、套边界、按各自周期错峰排期、重置、科技丢失判定。 |
